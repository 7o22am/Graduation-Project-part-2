        ...
        <table class="table table-striped table-success  w-75">
            ...
            <tbody>
                <?php 
                    ...
                    include("db.php");
                    for($i=0; $i<7; $i++){
                    $sql = "select id , name_doc  , subject , day  , subject_hours , timee , groupss , modarg  from lect3 where day = '$day_arr[$i]'";
                    $q = $db->prepare($sql) ;
                    $q->execute();
                    $data = $q->fetchAll();
                    foreach($data as $d){
                ...
                <tr>
                        ...
                        <td><?php echo $d['groupss'];?></td>
                        <td><?php echo $d['modarg'];?></td>
                        <!-- <td><a href="update3.php?id=<?php echo $d['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true" style="cursor: pointer;"></i></a></td> -->
                        <td class="wrapper"><a href="delete3.php?ids=<?php echo $d['id'];?>"><i class="fa fa-trash-o" aria-hidden="true" style="cursor: pointer; color:red" ></i></a></td>
