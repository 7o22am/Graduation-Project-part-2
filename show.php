        ...
        <table class="table table-striped table-success  w-75">
            ...
            <thead class="thead-inverse">
                <tr>
                    ...
                    <th style="background-color: #FF9A00;color: #fff">Time</th>
            ...
            $day_arr = array('Saturday','Sunday','Monday','Tuesday','Wednesday','Thursday','Friday');
                include("db.php");
                for($i=0; $i<7; $i++){
                $sql = "select id , name_doc  , subject , day , subject_hours  , timee , modarg  from lect1 where day = '$day_arr[$i]'";
                $q = $db->prepare($sql) ;
                $q->execute();
                $data = $q->fetchAll();
                foreach($data as $d){
                ...
                <tr>
                        ...
                        <td class="wrapper"><a href="delete.php?ids=<?php echo $d['id'];?>"><i class="fa fa-trash-o" aria-hidden="true" style="cursor: pointer; color:red" ></i></a></td>
